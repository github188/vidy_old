...
CC=g++
CXXFLAGS=-g -Wall -I${DIR_INC} -I${DIR_3RD} -I${DIR_3RD_OPENCV} -I${DIR_3RD_OPENCV2} -I${DIR_3RD_MYSQL} -I${DIR_3RD_X264}
LDFLAGS = -L${DIR_LIB} -L${DIR_LIB_OPENCV} -Wl,-rpath=../lib/lib_opencv-2.4.9_x86 -L${DIR_LIB_MYSQL} -Wl,-rpath=../lib/lib_mysql6.1.5_i686 -L${DIR_LIB_X264} -Wl,-rpath=../lib/x264
...
${BIN_TARGET} : ${OBJ}
	$(CC) $(OBJ) -o $@ $(LDFLAGS) ${LIBS_OPENCV} ${LIBS_MYSQL} ${LIB_X264}
